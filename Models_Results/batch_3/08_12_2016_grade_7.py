...
almost_all = {
   ...
   'intervention': 'all',
   'mobility': 'all',
   'oaa_normalized': {'except': ['like_pl','like_percentile',7,8]},
   'snapshots': 'all'
   }
basic = {
         ...
         for outcome in outcome_list:
            ...
            for years, grades in time_scales:
               ...
               template_options['name'] = template_options\
                                          ['batch_name']+\
                                          '_param_set_'+str(c)
               template_options['description']= "third pass for grade 7"
               ...
               try:
                  ...
                  raise
               print('param set {0} finished: run for {1} seconds so far'                           .format(c, batch_timer.time_check()))
               c = c+1
